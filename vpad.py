...
font_size['values'] = tuple(range(8,80,4))
font_size.current(0)
...
#align_center button
align_center_icon = tk.PhotoImage(file='icons2/underline.png')
...
def chane_font_color():
    color_var = tk.colorchooser.askcolor()
    text_editor.configure(fg=color_var[1])

font_color_btn.configure(command=chane_font_color)
...
def change_theme():
    ...
    fgcolor, bgcolor = color_tuple[0], color_tuple[1]
...
#find icons from flat icons website
